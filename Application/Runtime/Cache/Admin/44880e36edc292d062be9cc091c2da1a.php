...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class=""><a href="<?php echo U('Goods/tianjia');?>"><span><img src="/Public/Admin/images/t01.png" /></span></a>添加</li>
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                ...
                <td align="center"><img src="<?php echo (substr($v["goods_big_img"],1)); ?>" alt="" width="80" height="106"></td>
                <td align="center"><img src="<?php echo (substr($v["goods_small_img"],1)); ?>" alt="" width="70" height="94"></td>
    ...
    <div class="pagin"><?php echo ($pagelist); ?></div>
