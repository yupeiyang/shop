    ...
    <div class="loginbox">
      ...
      <form action="" method="post">
          <ul style="margin-top:30px;">
            <li><input name="manager_name" type="text" class="loginuser" value="用户名" onclick="JavaScript:this.value=''"/></li>
            <li><input name="manager_pwd" type="text" class="loginpwd" value="密码" onclick="JavaScript:this.value=''"/></li>
            <li>
                <input name="manager_verify" type="text" class="loginpwd" value="验证码" onclick="JavaScript:this.value=''" style="width:130px;vertical-align:middle;" maxlength="4"/>  <img src="/index.php/Admin/Manager/verifyImg" alt="" style="width:128px;height:36px;vertical-align:middle;" 
