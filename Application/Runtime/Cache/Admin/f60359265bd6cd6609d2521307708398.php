...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <ul class="forminfo">
            ...
            <li><label>商品数量</label>
                <input name="goods_number" type="text" class="dfinput" /></li>
            <li><label>商品重量</label>
                <input name="goods_weight" type="text" class="dfinput" /></li>
            <li><label>商品图片</label>
                <input name="goods_logo" type="file" class="dfinput" /></li>
            <li><label>商品简介</label>
                <textarea name="goods_introduce" cols="" rows="" class="textinput"></textarea></li>
            <li><label>&nbsp;</label>
                <input name="" type="submit" class="btn" value="提交"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('showlist');?>">返回</a></li>
        </ul>
    </form>
